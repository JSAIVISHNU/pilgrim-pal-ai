...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DkM05g7h.js");
...
const manifest = {
  "0a930c94c13eff8589bc6dc2dedf5ad1c61bb2f8d3d648c321da097fcef1dd70": {
    functionName: "translateImage_createServerFn_handler",
    importer: () => import("./translate.functions-DNUdcruB.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BfSkW1Cu.js"),
    import("./start-KV9h0fJg.js"),
